 ...
 *
 */
package com.boot.generator.mp.db;

import com.boot.generator.mp.config.ConfigurationHolder;
import com.boot.generator.mp.config.PropertyHolder;
import com.boot.generator.mp.util.ObjectFactory;
import com.boot.generator.mp.util.StringUtility;
...
public class ConnectionFactory {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        // 获取到数据库类型
        String db = PropertyHolder.getJDBCProperty("DB");
